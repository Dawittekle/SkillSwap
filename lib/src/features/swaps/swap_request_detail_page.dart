...
class SwapRequestDetailPage extends StatefulWidget {
  const SwapRequestDetailPage({
  ...
  @override
  State<SwapRequestDetailPage> createState() => _SwapRequestDetailPageState();
}

class _SwapRequestDetailPageState extends State<SwapRequestDetailPage> {
