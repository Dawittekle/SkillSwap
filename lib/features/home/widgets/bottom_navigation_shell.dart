...
import 'package:skill_swap/features/profile/pages/my_profile_page.dart';
import 'package:skill_swap/features/swaps/pages/my_swaps_page.dart';
...
class _BottomNavigationShellState extends State<BottomNavigationShell> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabs = [
      ...
      DiscoverPage(initialQuery: _discoverQuery),
      MySwapsPage(onSelectTab: _selectTab),
      const MessagesPage(),
      const MyProfilePage(),
    ];
